# 👾 Jogo Pac-Man em Assembly 

Projeto desenvolvido em Assembly para o simulador do processador P3, simulando um jogo no estilo Pac-Man com movimentação via interrupções, movimentação básica para os inimigos, sistema de pontuação e vidas, detecção de colisões, e mapas de vitória/derrota.
...
- Movimentação básica de perseguição para quatro inimigos
